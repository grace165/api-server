...
const sendVerificationEmail = (toEmail, username, token) => {
    sendOneButtonEmail({
        to: toEmail,
        from: { name: 'The Study Buddy', email: 'tkendrick@eagles.bridgewater.edu' },
        ...
        thirdLine: 'Thank you!',
        buttonURL: `https://victorious-island-0eb85050f.4.azurestaticapps.net/verify.html?token=${token}`,
